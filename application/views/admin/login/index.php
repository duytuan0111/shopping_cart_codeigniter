...
<html lang="en">
  <head>
    ...
    <title>Trang quản trị | The BrotherHood Việt Nam </title>
    <link rel="icon" href="<?php echo base_url() ?>public/home/img/logo/logo.png" type="image/ico" />
    <!-- Bootstrap -->
          ...
          <section class="login_content">
            <form method="POST" action="<?php echo base_url(); ?>admin/auth/login">
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-users"></i> The BrotherHood Việt Nam</h1>
                </div>
              </div>
            </form>
          </section>
